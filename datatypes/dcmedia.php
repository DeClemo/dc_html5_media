...
/*!
  \class dcMedia dcmedia.php
  \ingroup eZDatatype
  \brief The class dcMedia handles registered media files

*/

class dcMedia extends eZPersistentObject
{
    function dcMedia( $row )
    {
    ...
    static function fetch( $id, $version, $asObject = true )
    {
        if( $version == null )
        {
            return eZPersistentObject::fetchObjectList( dcMedia::definition(),
                                                        null,
        ...
        {
            return eZPersistentObject::fetchObject( dcMedia::definition(),
                                                    null,
                                                    array( "contentobject_attribute_id" => $id,
                                                           "version" => $version ),
                                                    $asObject );
    ...
    static function fetchByContentObjectID( $contentObjectID, $languageCode = null, $asObject = true )
    {
        ...
        $condition['data_type_string'] = 'dcmedia';
        ...
        foreach ( $ids as $id )
        {
            $mediaFileObjectAttribute = dcMedia::fetch( $id['id'], null, $asObject );
    ...
    static function removeByID( $id, $version )
    {
        if( $version == null )
        {
            eZPersistentObject::removeObject( dcMedia::definition(),
                                              array( "contentobject_attribute_id" => $id ) );
        }
        else
        {
